        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
               ...
               ch(ans);
                ...
                String url = "http://172.22.24.5/conect/ques.php";
                String rt = "http://172.22.24.5/conect/ans_one.php";
                String tt = "http://172.22.24.5/conect/ans_two.php";
                String ff = "http://172.22.24.5/conect/in.php";
