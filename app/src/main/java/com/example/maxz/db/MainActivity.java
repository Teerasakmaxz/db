        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
               ...
               ch(ans);
                ...
                String url = "http://172.20.10.2/conect/ques.php";
                String rt = "http://172.20.10.2/conect/ans_one.php";
                String tt = "http://172.20.10.2/conect/ans_two.php";
                String ff = "http://172.20.10.2/conect/in.php";
